...
export function InfiniteRibbon({
  ...
  return (
    <div
      className={cn(
        "w-full max-w-full overflow-hidden bg-[#D9692A] py-3.5 text-zinc-950 text-base md:text-lg font-black tracking-widest dark:bg-[#D9692A] dark:text-zinc-950 select-none shadow-xl",
        className
      )}
