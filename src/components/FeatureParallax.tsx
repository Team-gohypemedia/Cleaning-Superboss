...
const features = [
  {
    ...
    accent: "text-[#0d47a1]",
    iconBg: "bg-[#e3f2fd] border-[#d0e4f7]",
  },
  {
    icon: Move,
...
export default function FeatureParallax() {
  return (
    <section id="features" className="relative py-32 px-6 overflow-hidden bg-[#f8fbfe]">
      {/* Background ambient light */}
      <div className="absolute top-1/2 left-0 w-96 h-96 bg-[#0d47a1]/5 rounded-full blur-[150px] pointer-events-none" />
      <div className="absolute top-1/3 right-0 w-96 h-96 bg-[#2196f3]/5 rounded-full blur-[150px] pointer-events-none" />

      <div className="max-w-7xl mx-auto space-y-16">
        {/* Section Header */}
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-[#d0e4f7] text-[#0d47a1] text-xs font-semibold uppercase tracking-wider shadow-2xs">
            Deep Parallax Architecture
          </div>
          <h2 className="text-4xl md:text-6xl font-extrabold tracking-tight text-[#08295b]">
            Engineered for <span className="text-gradient-primary">Immersion</span>
          </h2>
          <p className="text-[#08295b]/70 text-base md:text-lg">
              ...
              <ParallaxLayer key={idx} speed={feature.speed}>
                ...
                >
                  ...
                  <div className="space-y-2">
                    <h3 className="text-xl font-bold text-[#08295b] group-hover:text-[#0d47a1] transition-colors">
                      {feature.title}
                    </h3>
                  ...
                  <div className="pt-4 flex items-center justify-between border-t border-[#d0e4f7] text-xs font-mono text-[#08295b]/60">
